    ...
    <div class="container p-5">
            ...
            <div class="container p-2">
              ...
              <div style="margin-top: 10px;">
                <div style="margin-left: 10px;">
                  <a style="text-align: right;" role="button" class="btn btn-dark"
                    href="https://www.google.com.vn/?hl=vi"><span style="text-decoration:underline">Learn
                      More</span></a>
                </div>
              </div>
            </div>
      ...
      <div class="container p-5">
          <div class="card wm-100" style="background-color: rgb(80, 83, 83);">
            ...
            <div class="d-flex bd-highlight">
              ...
              <div class="p-2 flex-fill bd-highlight"><a role="button" class="btn btn-dark float-end" href="https://www.google.com.vn/?hl=vi">View More</a></div>
            </div>
            <div class="row">
              <!-- One -->
              <div class="col-lg-3">
                <div>
                  <img src="./img2/download-a-game-of-thrones-offer-1q8ei.jpg"
                    class="image img-fluid rounded-top">
                  <button type="button" class="btn btn-primary" style="width:100%">FREE NOW</button>
                </div>
                <div class="container p-2">
                  <h2 style="text-align: center; color:white;font-size: 18px;">A Game Of Thrones: The Board Game Digital Edition</h2>
              ...
              <div class="col-lg-3">
                <div>
                  <img src="./img2/EGS_CarMechanicSimulator2018_RedDotGames_S2_1200x1600-f285924f9144353f57ac4631f0c689e6.jpg"
                    class="image img-fluid rounded-top">
                  <button type="button" class="btn btn-primary" style="width:100%">FREE NOW</button>
                </div>
                <div class="container p-2">
              ...
              <div class="col-lg-3">
                <div>
                  <img src="./img2/egs-geneforge1mutagen-spiderwebsoftware-s2-1200x1600-047ee886480c-1200x1600-668dc5abed1824b419b20b21c362904e.jpg"
                    class="image img-fluid rounded-top">
              ...
              <div class="box1 pt-3">
                <div class="text1">The Caligula Effect 2</div>
                  <div class="d-flex pt-2">
                    <div class="card bg-primary pt-1 px-2" style="color: white;font-size: 13px;">-30%</div>
                    <div class="pt-2 px-3" style="color: #F5F5F599; text-decoration: line-through;">₫165,000</div>
      ...
      <div class="container p-5">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="container p-2">
              <h2 style="text-align: center; color:white;font-size: 18px;">God Of War - 50% off</h2>
              <p style="color: grey;text-align: center;">Venture into the brutal Norse realms and fight to fulfill a deeply personal quest.</p>
              <div class="d-flex pt-2">
                <div class="card bg-primary pt-1 px-2" style="color: white;font-size: 10px;">-30%</div>
                <div class="pt-2 px-3" style="color: #F5F5F599; text-decoration: line-through;">₫165,000</div>
                <div class="pt-2" style="color: white;">₫165,000</div>
              </div>
            </div>
          ...
          <div class="col-md-6">
            ...
            <div class="container p-2">
              <h2 style="text-align: center; color:white;font-size: 18px;">Roller Champions - Play for Free!</h2>
              <p style="color: grey;text-align: center;">Welcome to Disco Fever, Season 1 of Roller Champions! Download free and Roll to Glory!</p>
      ...
      <div class="container p-5">
        <div class="row">
          <!-- One -->
          <div class="col-md-8">
            <img src="./img/AC1.jpg" class="img-fluid rounded-4">
          </div>
          <!-- Two -->
          <div class="col-md-4">
            <div class="container">
