        ...
        <div class="col-9">
          <div class="row pb-5">
            ...
            <div class="col-3"><img src="./img2/download-jars-offer-13zfp.jpg" style="width:100%" alt="#">
              <div class="box1 pt-3">
                ...
                <div class="d-flex pt-2">
                  <div class="text-white bg-primary pt-1 px-1 rounded-2">-60%</div>
                  <div class="pt-2 px-2" style="color: #F5F5F599; text-decoration: line-through;">₫140,000</div>
                  <div class="pt-2" style="color: white;">₫56,000</div>
                </div>
              </div>
            </div>
          ...
          <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
              ...
              <li class="page-item">
                <a class="page-link bg-black text-white" href="browse3.php" aria-label="Next">
